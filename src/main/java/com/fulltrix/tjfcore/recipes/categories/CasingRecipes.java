...
import static com.fulltrix.tjfcore.item.TJFHeatingCoil.CoilType.*;
import static com.fulltrix.tjfcore.item.TJFMultiblockCasing2.CasingType.*;
import static com.fulltrix.tjfcore.item.TJFReactorCasing.CasingType.*;
import static com.fulltrix.tjfcore.item.TJFTransparentCasing.CasingType.*;
import static com.fulltrix.tjfcore.item.fusion.TJFFusionCasing.CasingType.*;
...
public class CasingRecipes {
    ...
    private static void coilCasings() {
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder().EUt(122880).duration(400)
                ...
                .input(circuit, LuV)
                .fluidInputs(Helium.getFluid(4000))
                .outputs(TJFMetaBlocks.FUSION_CASING.getItemVariant(FUSION_COIL_2))
                .buildAndRegister();
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder().EUt(491520).duration(400)
                ...
                .input(circuit, ZPM)
                .fluidInputs(Helium.getFluid(4000))
                .outputs(TJFMetaBlocks.FUSION_CASING.getItemVariant(FUSION_COIL_3))
                .buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(200).EUt(500000)
                ...
                .outputs(TJFMetaBlocks.HEATING_COIL.getItemVariant(TITAN_STEEL_COIL))
                .buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(200).EUt(2000000)
                ...
                .outputs(TJFMetaBlocks.HEATING_COIL.getItemVariant(PIKYONIUM_COIL))
                .buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(200).EUt(8000000)
                ...
                .outputs(TJFMetaBlocks.HEATING_COIL.getItemVariant(BLACK_TITANIUM_COIL))
                .buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(200).EUt(32000000)
                ...
                .outputs(TJFMetaBlocks.HEATING_COIL.getItemVariant(NEUTRONIUM_COIL))
                .buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(200).EUt(32000000)
                ...
                .outputs(TJFMetaBlocks.HEATING_COIL.getItemVariant(COSMIC_NEUTRONIUM_COIL))
                .buildAndRegister();
    ...
    private static void multiblockCasings() {
        ...
        */
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(150).EUt(500000)
                ...
                .outputs(TJFMetaBlocks.MULTIBLOCK_CASING2.getItemVariant(STELLAR_CONTAINMENT, 4))
                .buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(150).EUt(500000)
                ...
                .outputs(TJFMetaBlocks.REACTOR_CASING.getItemVariant(HYPER_CASING, 4))
                .buildAndRegister();

        // Hyper Reactor Casing 2
        ASSEMBLER_RECIPES.recipeBuilder().duration(150).EUt(2000000)
                .fluidInputs(SolderingAlloy.getFluid(L * 4))
                .inputs(TJFMetaBlocks.REACTOR_CASING.getItemVariant(HYPER_CASING))
                .input(screw, Pikyonium, 16)
                .input(plate, TitanSteel, 8)
                .outputs(TJFMetaBlocks.REACTOR_CASING.getItemVariant(HYPER_CASING_2, 4))
                .buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(150).EUt(500000)
                ...
                .input(circuit, UV)
                .outputs(TJFMetaBlocks.REACTOR_CASING.getItemVariant(HYPER_CORE, 4))
                .buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(150).EUt(2000000)
                ...
                .inputs(TJFMetaBlocks.REACTOR_CASING.getItemVariant(HYPER_CASING, 2))
                .input(screw, Rutherfordium, 16)
                .input(plate, TungstenTitaniumCarbide, 4)
                .input(circuit, UHV)
                .outputs(TJFMetaBlocks.REACTOR_CASING.getItemVariant(HYPER_CORE_2, 4))
                .buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(150).EUt(8000000)
                ...
                .inputs(TJFMetaBlocks.REACTOR_CASING.getItemVariant(HYPER_CASING_2, 2))
                .input(screw, TriniumTitanium, 16)
                .input(plate, TitanSteel, 4)
                .input(circuit, UEV)
                .outputs(TJFMetaBlocks.REACTOR_CASING.getItemVariant(HYPER_CORE_3, 4))
                .buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(150).EUt(120000)
                ...
                .outputs(TJFMetaBlocks.MULTIBLOCK_CASING2.getItemVariant(TJFMultiblockCasing2.CasingType.BIO_REACTOR, 2))
                .buildAndRegister();
