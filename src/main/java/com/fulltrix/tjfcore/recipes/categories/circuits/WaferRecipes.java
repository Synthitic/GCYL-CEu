...
public class WaferRecipes {
    public static void init() { //TODO remove neutronium, verify recipes work
        ...
        LASER_ENGRAVER_RECIPES.recipeBuilder().duration(25).EUt(122880).inputs(WAFER_NEUTRONIUM.getStackForm()).notConsumable(craftingLens, LightGray).outputs(RANDOM_ACCESS_MEMORY_WAFER.getStackForm(20)).buildAndRegister();
        ...
        LASER_ENGRAVER_RECIPES.recipeBuilder().duration(12).EUt(7_864_320).inputs(WAFER_NEUTRONIUM.getStackForm()).notConsumable(lens, Amethyst).outputs(ULTRA_HIGH_POWER_INTEGRATED_CIRCUIT_WAFER.getStackForm(4)).buildAndRegister();
        ...
        LASER_ENGRAVER_RECIPES.recipeBuilder().duration(12).EUt(7_864_320).inputs(WAFER_NEUTRONIUM.getStackForm()).notConsumable(lens, CubicZirconia).outputs(HIGHLY_ADVANCED_SOC_WAFER.getStackForm(8)).buildAndRegister();
