...
import static com.fulltrix.tjfcore.item.TJFExplosive.ExplosiveType.*;
import static com.fulltrix.tjfcore.item.TJFMetaBlocks.*;
import static com.fulltrix.tjfcore.item.fusion.TJFFusionCasing.CasingType.ADV_FUSION_COIL_1;
