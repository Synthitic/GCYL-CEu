...
public class UltimateMaterials {
    public static void init() { //TODO Verify Recipes
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(150).EUt(15000000)
                ...
                .inputs(TJFMetaBlocks.FUSION_CASING.getItemVariant(TJFFusionCasing.CasingType.ADV_FUSION_COIL_3))
        ...
        STELLAR_FORGE_RECIPES.recipeBuilder().duration(10).EUt(125000000)
                ...
                .inputs(TJFMetaBlocks.EXPLOSIVE.getItemVariant(TJFExplosive.ExplosiveType.QCD_CHARGE))
        ...
        STELLAR_FORGE_RECIPES.recipeBuilder().duration(10).EUt(125000000)
                ...
                .inputs(TJFMetaBlocks.EXPLOSIVE.getItemVariant(TJFExplosive.ExplosiveType.QCD_CHARGE, 2))
