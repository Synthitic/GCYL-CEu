...
import com.fulltrix.tjfcore.item.TJFExplosive;
import com.fulltrix.tjfcore.item.TJFMetaBlocks;
import com.fulltrix.tjfcore.item.TJFSimpleBlock;
...
import static com.fulltrix.tjfcore.recipes.TJFRecipeMaps.PLASMA_CONDENSER_RECIPES;
import static com.fulltrix.tjfcore.recipes.TJFRecipeMaps.STELLAR_FORGE_RECIPES;
...
public class UHVMaterials {
    public static void init() {
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .outputs(TJFMetaBlocks.EXPLOSIVE.getItemVariant(TJFExplosive.ExplosiveType.NAQUADRIA_CHARGE))
                .EUt(1966080)
                .duration(100)
                .buildAndRegister();
        ...
        STELLAR_FORGE_RECIPES.recipeBuilder()
                .input(ingot, Rhenium)
                .inputs(TJFMetaBlocks.EXPLOSIVE.getItemVariant(TJFExplosive.ExplosiveType.NAQUADRIA_CHARGE))
        ...
        VACUUM_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(Helium.getFluid(FluidStorageKeys.LIQUID, 5000))
                .EUt(7680)
                .duration(20)
                .buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .outputs(TJFMetaBlocks.EXPLOSIVE.getItemVariant(TJFExplosive.ExplosiveType.TARANIUM_CHARGE))
                .EUt(7_864_320)
                .duration(20)
                .buildAndRegister();
        ...
        FLUID_SOLIDFICATION_RECIPES.recipeBuilder()
                ...
                .outputs(TJFMetaBlocks.SIMPLE_BLOCK.getItemVariant(TJFSimpleBlock.BlockType.SUPERHEAVY_BLOCK))
                .EUt(100000000)
                .duration(40)
                .buildAndRegister();

        STELLAR_FORGE_RECIPES.recipeBuilder()
                .inputs(TJFMetaBlocks.SIMPLE_BLOCK.getItemVariant(TJFSimpleBlock.BlockType.SUPERHEAVY_BLOCK))
                .inputs(TJFMetaBlocks.EXPLOSIVE.getItemVariant(TJFExplosive.ExplosiveType.TARANIUM_CHARGE))
