...
public class WormholeGeneratorChain { //TODO research
    public static void init() {
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(200).EUt(100000)
                ...
                .inputs(TJFMetaBlocks.EXPLOSIVE.getItemVariant(TJFExplosive.ExplosiveType.TARANIUM_CHARGE))
                .outputs(TJFMetaBlocks.EXPLOSIVE.getItemVariant(TJFExplosive.ExplosiveType.LEPTONIC_CHARGE))
                .buildAndRegister();
        ...
        STELLAR_FORGE_RECIPES.recipeBuilder().duration(600).EUt(5000000)
                ...
                .inputs(TJFMetaBlocks.EXPLOSIVE.getItemVariant(TJFExplosive.ExplosiveType.LEPTONIC_CHARGE))
                .inputs(CONTAINED_HIGH_DENSITY_PROTONIC_MATTER.getStackForm())
