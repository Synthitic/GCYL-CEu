    ...
    PUMP {
        ...
        public Object getIngredient(int tier) {
            switch (tier) {
                ...
                case 14:
                default:
                    return TJFCoreItems.ELECTRIC_PUMP_MAX;
            }
        }
    },
    CABLE_SINGLE {
    ...
    GLASS {
        ...
        public Object getIngredient(int tier) {
            switch (tier) {
                ...
                case 3:
                    return TJFMetaBlocks.TRANSPARENT_CASING.getItemVariant(TJFTransparentCasing.CasingType.BOROSILICATE_GLASS);
                case 4:
                    return TJFMetaBlocks.TRANSPARENT_CASING.getItemVariant(TJFTransparentCasing.CasingType.NICKEL_GLASS);
                case 5:
                    return TJFMetaBlocks.TRANSPARENT_CASING.getItemVariant(TJFTransparentCasing.CasingType.CHROME_GLASS);
                case 6:
                    return TJFMetaBlocks.TRANSPARENT_CASING.getItemVariant(TJFTransparentCasing.CasingType.TUNGSTEN_GLASS);
                case 7:
                    return TJFMetaBlocks.TRANSPARENT_CASING.getItemVariant(TJFTransparentCasing.CasingType.IRIDIUM_GLASS);
                default:
                    return TJFMetaBlocks.TRANSPARENT_CASING.getItemVariant(TJFTransparentCasing.CasingType.OSMIRIDIUM_GLASS);
            }
        }
    },
    PLATE {
    ...
    MOTOR {
        ...
        public Object getIngredient(int tier) {
            switch (tier) {
                ...
                case 14:
                default:
                    return TJFCoreItems.ELECTRIC_MOTOR_MAX;
    ...
    SENSOR {
        ...
        public Object getIngredient(int tier) {
            switch (tier) {
                ...
                case 14:
                default:
                    return TJFCoreItems.SENSOR_MAX;
            }
        }
    },
    PISTON {
        ...
        public Object getIngredient(int tier) {
            switch (tier) {
                ...
                case 14:
                default:
                    return TJFCoreItems.ELECTRIC_PISTON_MAX;
    ...
    EMITTER {
        ...
        public Object getIngredient(int tier) {
            switch (tier) {
                ...
                case 14:
                default:
                    return TJFCoreItems.EMITTER_MAX;
            }
        }
    },
    CONVEYOR {
        ...
        public Object getIngredient(int tier) {
            switch (tier) {
                ...
                case 14:
                default:
                    return TJFCoreItems.CONVEYOR_MODULE_MAX;
            }
        }
    },
    ROBOT_ARM {
        ...
        public Object getIngredient(int tier) {
            switch (tier) {
                ...
                case 14:
                default:
                    return TJFCoreItems.ROBOT_ARM_MAX;
            }
        }
    },
    COIL_HEATING {
    ...
    FIELD_GENERATOR {
        ...
        public Object getIngredient(int tier) {
            switch (tier) {
                ...
                case 14:
                default:
                    return TJFCoreItems.FIELD_GENERATOR_MAX;
            }
        }
    },
    COIL_HEATING_DOUBLE {
