...
import static com.fulltrix.tjfcore.client.ClientHandler.NAQUADRIA_CASING;
import static com.fulltrix.tjfcore.item.TJFMetaBlocks.METAL_CASING_2;
import static gregtech.api.unification.material.Materials.Naquadria;
import static gregtech.common.blocks.BlockTurbineCasing.TurbineCasingType.TUNGSTENSTEEL_TURBINE_CASING;
...
public class MetaTileEntityLargeNaquadahReactor extends FuelMultiblockController implements IProgressBarMultiblock {
    ...
    public MetaTileEntityLargeNaquadahReactor(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, TJFRecipeMaps.NAQUADAH_REACTOR_FUELS, tier);
