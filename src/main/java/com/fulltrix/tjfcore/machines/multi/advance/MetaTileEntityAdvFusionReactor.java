...
public class MetaTileEntityAdvFusionReactor extends RecipeMapMultiblockController implements ITieredMetaTileEntity, IFastRenderMetaTileEntity, IBloomEffect {
    ...
    public MetaTileEntityAdvFusionReactor(ResourceLocation metaTileEntityId, int tier) {
        super(metaTileEntityId, TJFRecipeMaps.ADV_FUSION_RECIPES);
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .where('b', states(TJFMetaBlocks.FUSION_CASING.getState(TJFFusionCasing.CasingType.FUSION_BLANKET))
    ...
    private IBlockState getCasingState() {
        return TJFMetaBlocks.FUSION_CASING.getState(TJFFusionCasing.CasingType.ADV_FUSION_CASING);
    }
    ...
    private IBlockState getCoilState() {
        if (tier == GTValues.UHV)
            return TJFMetaBlocks.FUSION_CASING.getState(TJFFusionCasing.CasingType.ADV_FUSION_COIL_1);
        if (tier == GTValues.UEV)
            return TJFMetaBlocks.FUSION_CASING.getState(TJFFusionCasing.CasingType.ADV_FUSION_COIL_2);
        if (tier == GTValues.UIV)
            return TJFMetaBlocks.FUSION_CASING.getState(TJFFusionCasing.CasingType.ADV_FUSION_COIL_3);
        if (tier == GTValues.UXV)
            return TJFMetaBlocks.FUSION_CASING.getState(TJFFusionCasing.CasingType.ADV_FUSION_COIL_4);

        return TJFMetaBlocks.FUSION_CASING.getState(TJFFusionCasing.CasingType.ADV_FUSION_COIL_5);
    }

    private IBlockState getCryostatState() {
        if (tier == GTValues.UHV)
            return TJFMetaBlocks.CRYOSTAT_CASING.getState(TJFCryostatCasing.CasingType.CRYOSTAT_1);
        if (tier == GTValues.UEV)
            return TJFMetaBlocks.CRYOSTAT_CASING.getState(TJFCryostatCasing.CasingType.CRYOSTAT_2);
        if (tier == GTValues.UIV)
            return TJFMetaBlocks.CRYOSTAT_CASING.getState(TJFCryostatCasing.CasingType.CRYOSTAT_3);
        if (tier == GTValues.UXV)
            return TJFMetaBlocks.CRYOSTAT_CASING.getState(TJFCryostatCasing.CasingType.CRYOSTAT_4);

        return TJFMetaBlocks.CRYOSTAT_CASING.getState(TJFCryostatCasing.CasingType.CRYOSTAT_5);
    }

    private IBlockState getDivertorState() {
        if (tier == GTValues.UHV)
            return TJFMetaBlocks.DIVERTOR_CASING.getState(TJFDivertorCasing.CasingType.DIVERTOR_1);
        if (tier == GTValues.UEV)
            return TJFMetaBlocks.DIVERTOR_CASING.getState(TJFDivertorCasing.CasingType.DIVERTOR_2);
        if (tier == GTValues.UIV)
            return TJFMetaBlocks.DIVERTOR_CASING.getState(TJFDivertorCasing.CasingType.DIVERTOR_3);
        if (tier == GTValues.UXV)
            return TJFMetaBlocks.DIVERTOR_CASING.getState(TJFDivertorCasing.CasingType.DIVERTOR_4);

        return TJFMetaBlocks.DIVERTOR_CASING.getState(TJFDivertorCasing.CasingType.DIVERTOR_5);
    }
    ...
    private IBlockState getVacuumState() {
        if (tier == GTValues.UHV)
            return TJFMetaBlocks.VACUUM_CASING.getState(TJFVacuumCasing.CasingType.VACUUM_1);
        if (tier == GTValues.UEV)
            return TJFMetaBlocks.VACUUM_CASING.getState(TJFVacuumCasing.CasingType.VACUUM_2);
        if (tier == GTValues.UIV)
            return TJFMetaBlocks.VACUUM_CASING.getState(TJFVacuumCasing.CasingType.VACUUM_3);
        if (tier == GTValues.UXV)
            return TJFMetaBlocks.VACUUM_CASING.getState(TJFVacuumCasing.CasingType.VACUUM_4);

        return TJFMetaBlocks.VACUUM_CASING.getState(TJFVacuumCasing.CasingType.VACUUM_5);
    }

    @Override
    protected void formStructure(PatternMatchContext context) {
        super.formStructure(context);
        TJFFusionCasing.CasingType coil = context.getOrDefault("Coil", TJFFusionCasing.CasingType.ADV_FUSION_COIL_1);
        coilTier = Integer.parseInt(coil.getName().substring(coil.getName().length() - 1));
        vacuumTier = context.getOrDefault("Vacuum", TJFVacuumCasing.CasingType.VACUUM_1).getTier();
        divertorTier = context.getOrDefault("Divertor", TJFDivertorCasing.CasingType.DIVERTOR_1).getTier();
        int cryostatTier = context.getOrDefault("Cryostat", TJFCryostatCasing.CasingType.CRYOSTAT_1).getTier();
    ...
    public void renderMetaTileEntity(double x, double y, double z, float partialTicks) {
        if (this.color != null && this.bloomRenderTicket == null) {
            this.bloomRenderTicket = BloomEffectUtil.registerBloomRender(MetaTileEntityAdvFusionReactor.FusionBloomSetup.INSTANCE, getBloomType(),
                    this);
        }
    }
    ...
    public void renderBloomEffect(@NotNull BufferBuilder buffer, @NotNull EffectRenderContext context) {
        ...
        RenderBufferHelper.renderRing(buffer,
                ...
                getPos().getY() - context.cameraY() + relativeBack.getYOffset() * 7 + 2,
