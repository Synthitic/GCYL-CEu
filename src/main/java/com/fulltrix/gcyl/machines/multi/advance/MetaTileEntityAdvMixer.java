...
public class MetaTileEntityAdvMixer extends GCYLRecipeMapMultiblockController {

    private long maxVoltage;

    public MetaTileEntityAdvMixer(ResourceLocation metaTileEnttityID) {
        super(metaTileEnttityID,  new RecipeMap[] {RecipeMaps.MIXER_RECIPES, GCYLRecipeMaps.ADVANCED_MIXER_RECIPES}, true);
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        MultiblockShapeInfo.Builder builder = MultiblockShapeInfo.builder(RIGHT, DOWN, FRONT)
                .aisle("#pEM#", "#XXX#", "#XXX#", "#XXX#", "#XXX#", "##F##")
                .aisle("XXXXX", "XACAX", "XAAAX", "XACAX", "XAAAX", "##F##")
                .aisle("XXXXX", "XCPCX", "XAPAX", "XCPCX", "XAPAX", "FFTFF")
                .aisle("XXXXX", "iACAo", "XAAAX", "XACAX", "XAAAX", "##F##")
                .aisle("#XXX#", "#ISO#", "#XXX#", "#XXX#", "#XXX#", "##F##")
                ...
                .where('P', this.getCasingState2())
                .where('C', this.getCasingState3())
                .where('F', MetaBlocks.FRAMES.get(GCYMMaterials.HastelloyX).getStateFromMeta(12));
